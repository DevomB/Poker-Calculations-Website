...
sidebar_label: alphaFrequency
description: "`1 - MDF` = exploit weight if hero never defends."
---

## Summary

`1 - MDF` = exploit weight if hero never defends.
...
**Concrete trigger:** `1 - MDF` = exploit weight if hero never defends.
...
// alphaFrequency(...) — see signature above
```
