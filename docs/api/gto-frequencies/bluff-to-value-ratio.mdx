...
sidebar_label: bluffToValueRatio
description: "Polarized river combo ratio `bet / (pot + 2×bet)`."
---
...
**Concrete trigger:** Polarized river combo ratio `bet / (pot + 2×bet)`.
...
// bluffToValueRatio(...) — see signature above
```
