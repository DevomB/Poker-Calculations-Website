...
sidebar_label: valueToBluffRatio
description: "Reciprocal; `Infinity` when bet is 0."
---

## Summary

Reciprocal; `Infinity` when bet is 0.
...
**Concrete trigger:** Reciprocal; `Infinity` when bet is 0.
...
// valueToBluffRatio(...) — see signature above
```
