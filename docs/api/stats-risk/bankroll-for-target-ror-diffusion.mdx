...
sidebar_label: bankrollForTargetRorDiffusion
description: "Inverse of `riskOfRuinDiffusionApprox` for bankroll `B`."
---

## Summary

Inverse of `riskOfRuinDiffusionApprox` for bankroll `B`.
...
**Concrete trigger:** Inverse of `riskOfRuinDiffusionApprox` for bankroll `B`.
...
// bankrollForTargetRorDiffusion(...) — see signature above
```
