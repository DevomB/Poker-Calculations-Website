...
sidebar_label: monteCarloStandardError
description: "monteCarloStandardError"
---

## Summary

Native export `monteCarloStandardError` from the `poker-calculations` addon.
...
// monteCarloStandardError(...) — see signature above
```
