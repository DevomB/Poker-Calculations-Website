...
sidebar_label: multiwaySymmetricBreakevenCallEquity
description: "multiwaySymmetricBreakevenCallEquity"
---

## Summary

Native export `multiwaySymmetricBreakevenCallEquity` from the `poker-calculations` addon.
...
// multiwaySymmetricBreakevenCallEquity(...) — see signature above
```

Runnable sample in the repo: [NPM/examples/multiway.mjs](https://github.com/DevomB/Poker-Calculations/blob/main/NPM/examples/multiway.mjs).
