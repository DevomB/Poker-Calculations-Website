...
sidebar_label: multiwaySymmetricBreakevenCallEquityWithShare
description: "Same geometry; `shareModel` `0` winner-take-all, `1` hero gets `heroFractionWhenWin` of final pot when winning."
---

## Summary

Same geometry; `shareModel` `0` winner-take-all, `1` hero gets `heroFractionWhenWin` of final pot when winning.
...
**Concrete trigger:** Same geometry; `shareModel` `0` winner-take-all, `1` hero gets `heroFractionWhenWin` of final pot when winning.
...
// multiwaySymmetricBreakevenCallEquityWithShare(...) — see signature above
```
