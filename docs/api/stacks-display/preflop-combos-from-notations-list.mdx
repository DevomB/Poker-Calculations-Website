...
sidebar_label: preflopCombosFromNotationsList
description: "Sum of combo counts over a list; empty → `0`."
---

## Summary

Sum of combo counts over a list; empty → `0`.
...
**Concrete trigger:** Sum of combo counts over a list; empty → `0`.
...
// preflopCombosFromNotationsList(...) — see signature above
```
