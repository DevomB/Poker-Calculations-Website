---
title: harringtonQ
sidebar_label: harringtonQ
description: "Harrington **Q** = hero stack / mean(table stacks); all stacks positive."
---

## Summary

Harrington **Q** = hero stack / mean(table stacks); all stacks positive.
...
**Concrete trigger:** Harrington **Q** = hero stack / mean(table stacks); all stacks positive.
...
// harringtonQ(...) — see signature above
```
