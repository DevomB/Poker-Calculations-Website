...
sidebar_label: orbitCostChips
description: "One orbit posted cost: sb + bb + sum of antes."
---

## Summary

One orbit posted cost: sb + bb + sum of antes.
...
**Concrete trigger:** One orbit posted cost: sb + bb + sum of antes.
...
// orbitCostChips(...) — see signature above
```
