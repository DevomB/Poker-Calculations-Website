...
sidebar_label: potOddsDisplayRatioFromBreakevenCallEquity
description: "Inverse: `(1−e)/e`; `+∞` when `e=0`; `0` when `e=1`."
---

## Summary

Inverse: `(1−e)/e`; `+∞` when `e=0`; `0` when `e=1`.
...
**Concrete trigger:** Inverse: `(1−e)/e`; `+∞` when `e=0`; `0` when `e=1`.
...
// potOddsDisplayRatioFromBreakevenCallEquity(...) — see signature above
```
