...
sidebar_label: breakevenCallEquityWithRake
description: "Breakeven equity when the **final** pot (after call) pays rake under that model."
---

## Summary

Breakeven equity when the **final** pot (after call) pays rake under that model.
...
**Concrete trigger:** Breakeven equity when the **final** pot (after call) pays rake under that model.
...
// breakevenCallEquityWithRake(...) — see signature above
```
