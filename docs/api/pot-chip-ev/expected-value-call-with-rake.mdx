...
sidebar_label: expectedValueCallWithRake
description: "Chip EV of call vs fold when the final HU pot pays rake (same rake model as breakeven-with-rake)."
---

## Summary

Chip EV of call vs fold when the final HU pot pays rake (same rake model as breakeven-with-rake).
...
**Concrete trigger:** Chip EV of call vs fold when the final HU pot pays rake (same rake model as breakeven-with-rake).
...
// expectedValueCallWithRake(...) — see signature above
```
