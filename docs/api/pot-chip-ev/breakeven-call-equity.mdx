...
sidebar_label: breakevenCallEquity
description: "Same fraction as `potOddsRatio` for chip calls."
---

## Summary

Same fraction as `potOddsRatio` for chip calls.
...
**Concrete trigger:** Same fraction as `potOddsRatio` for chip calls.
...
// breakevenCallEquity(...) — see signature above
```
