...
sidebar_label: ruleOfFourEquity
description: "ruleOfFourEquity"
---

## Summary

Native export `ruleOfFourEquity` from the `poker-calculations` addon.
...
// ruleOfFourEquity(...) — see signature above
```
