...
sidebar_label: straightMadeFlopToRiverExactProbability
description: "Exact probability of straight or better in hero’s best 7 after uniform random unordered turn+river from remaining deck."
---
...
**Concrete trigger:** Exact probability of straight or better in hero’s best 7 after uniform random unordered turn+river from remaining deck.
...
// straightMadeFlopToRiverExactProbability(...) — see signature above
```

Runnable sample in the repo: [NPM/examples/heuristics-draws.mjs](https://github.com/DevomB/Poker-Calculations/blob/main/NPM/examples/heuristics-draws.mjs).
