...
sidebar_label: hypergeometricOneCardHitProbability
description: "One-card draw: `outs / unseenCards`."
---

## Summary

One-card draw: `outs / unseenCards`.
...
**Concrete trigger:** One-card draw: `outs / unseenCards`.
...
// hypergeometricOneCardHitProbability(...) — see signature above
```
