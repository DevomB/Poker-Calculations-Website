...
sidebar_label: runnerRunnerStraightDrawHitProbability
description: "Runner–runner straight draw: `straightKind` `0` gutshot (4) / `1` OESD / `2` double-belly (8), minus dead among pattern outs."
---
...
**Concrete trigger:** Runner–runner straight draw: `straightKind` `0` gutshot (4) / `1` OESD / `2` double-belly (8), minus dead among pattern outs.
...
// runnerRunnerStraightDrawHitProbability(...) — see signature above
```
