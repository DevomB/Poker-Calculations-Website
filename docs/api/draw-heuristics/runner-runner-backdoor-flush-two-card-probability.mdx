...
sidebar_label: runnerRunnerBackdoorFlushTwoCardProbability
description: "`C(s,2)/C(u,2)` for two-card runner flush."
---
...
**Concrete trigger:** `C(s,2)/C(u,2)` for two-card runner flush.
...
// runnerRunnerBackdoorFlushTwoCardProbability(...) — see signature above
```
