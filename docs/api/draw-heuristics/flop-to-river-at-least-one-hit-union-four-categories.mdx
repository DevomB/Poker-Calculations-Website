...
sidebar_label: flopToRiverAtLeastOneHitUnionFourCategories
description: "Four categories; full inclusion–exclusion on card-count intersections, then same two-street formula."
---

## Summary

Four categories; full inclusion–exclusion on card-count intersections, then same two-street formula.
...
**Concrete trigger:** Four categories; full inclusion–exclusion on card-count intersections, then same two-street formula.
...
// flopToRiverAtLeastOneHitUnionFourCategories(...) — see signature above
```
