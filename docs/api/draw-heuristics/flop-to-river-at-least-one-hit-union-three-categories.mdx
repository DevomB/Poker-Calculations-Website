...
sidebar_label: flopToRiverAtLeastOneHitUnionThreeCategories
description: "Three categories; inclusion–exclusion on union size, then same two-street formula."
---

## Summary

Three categories; inclusion–exclusion on union size, then same two-street formula.
...
**Concrete trigger:** Three categories; inclusion–exclusion on union size, then same two-street formula.
...
// flopToRiverAtLeastOneHitUnionThreeCategories(...) — see signature above
```
