...
sidebar_label: flopToRiverAtLeastOneHitUnionTwoCategories
description: "Two categories with overlap; union cardinality in the two-draw formula."
---

## Summary

Two categories with overlap; union cardinality in the two-draw formula.
...
**Concrete trigger:** Two categories with overlap; union cardinality in the two-draw formula.
...
// flopToRiverAtLeastOneHitUnionTwoCategories(...) — see signature above
```
