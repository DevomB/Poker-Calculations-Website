...
sidebar_label: estimatedOutsFromRuleOfFour
description: "Same for two streets: `equity×unseen/4` clamped."
---

## Summary

Same for two streets: `equity×unseen/4` clamped.
...
**Concrete trigger:** Same for two streets: `equity×unseen/4` clamped.
...
// estimatedOutsFromRuleOfFour(...) — see signature above
```
