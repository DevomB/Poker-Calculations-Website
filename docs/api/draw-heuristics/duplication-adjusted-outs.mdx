...
sidebar_label: duplicationAdjustedOuts
description: "Heuristic `outs / (1 + weight × villains)`."
---
...
**Concrete trigger:** Heuristic `outs / (1 + weight × villains)`.
...
// duplicationAdjustedOuts(...) — see signature above
```
