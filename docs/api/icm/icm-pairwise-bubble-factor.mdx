...
sidebar_label: icmPairwiseBubbleFactor
description: "Loss/gain ratio from finite differences on `icmExpectedPayouts`."
---

## Summary

Loss/gain ratio from finite differences on `icmExpectedPayouts`.
...
**Concrete trigger:** Loss/gain ratio from finite differences on `icmExpectedPayouts`.
...
// icmPairwiseBubbleFactor(...) — see signature above
```
