...
sidebar_label: icmWinProbabilitiesHarville
description: "icmWinProbabilitiesHarville"
---

## Summary

Native export `icmWinProbabilitiesHarville` from the `poker-calculations` addon.
...
// icmWinProbabilitiesHarville(...) — see signature above
```

Runnable sample in the repo: [NPM/examples/icm.mjs](https://github.com/DevomB/Poker-Calculations/blob/main/NPM/examples/icm.mjs).
