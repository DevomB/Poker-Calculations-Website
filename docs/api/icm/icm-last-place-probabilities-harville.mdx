...
sidebar_label: icmLastPlaceProbabilitiesHarville
description: "Harville probability each player finishes **last** (placement matrix last column)."
---
...
**Concrete trigger:** Harville probability each player finishes **last** (placement matrix last column).
...
// icmLastPlaceProbabilitiesHarville(...) — see signature above
```
