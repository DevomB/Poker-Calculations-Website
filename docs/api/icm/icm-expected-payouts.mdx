...
sidebar_label: icmExpectedPayouts
description: "Expected payout per seat."
---

## Summary

Expected payout per seat.
...
**Concrete trigger:** Expected payout per seat.
...
// icmExpectedPayouts(...) — see signature above
```
