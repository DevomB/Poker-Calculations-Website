...
sidebar_label: icmHarvillePlacementProbabilities
description: "Full `n×n` Harville placement matrix (per player, per finish rank)."
---

## Summary

Full `n×n` Harville placement matrix (per player, per finish rank).
...
**Concrete trigger:** Full `n×n` Harville placement matrix (per player, per finish rank).
...
// icmHarvillePlacementProbabilities(...) — see signature above
```
