...
sidebar_label: parseCompactCardList
description: "Parse concatenated or whitespace-separated cards (`AhKh`, `10h Kd`); throws on duplicate or invalid token."
---

## Summary

Parse concatenated or whitespace-separated cards (`AhKh`, `10h Kd`); throws on duplicate or invalid token.
...
**Concrete trigger:** Parse concatenated or whitespace-separated cards (`AhKh`, `10h Kd`); throws on duplicate or invalid token.
...
// parseCompactCardList(...) — see signature above
```
