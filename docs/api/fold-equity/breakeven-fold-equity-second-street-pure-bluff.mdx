...
sidebar_label: breakevenFoldEquitySecondStreetPureBluff
description: "Breakeven second-street FE given first-street FE."
---

## Summary

Breakeven second-street FE given first-street FE.
...
**Concrete trigger:** Breakeven second-street FE given first-street FE.
...
// breakevenFoldEquitySecondStreetPureBluff(...) — see signature above
```
