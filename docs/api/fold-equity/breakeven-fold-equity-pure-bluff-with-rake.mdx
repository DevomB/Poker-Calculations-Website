...
sidebar_label: breakevenFoldEquityPureBluffWithRake
description: "Pure-bluff FE parallel to semi-bluff rake model."
---

## Summary

Pure-bluff FE parallel to semi-bluff rake model.
...
**Concrete trigger:** Pure-bluff FE parallel to semi-bluff rake model.
...
// breakevenFoldEquityPureBluffWithRake(...) — see signature above
```
