...
sidebar_label: breakevenFoldEquityFirstStreetPureBluff
description: "Breakeven first-street FE given second-street FE."
---

## Summary

Breakeven first-street FE given second-street FE.
...
**Concrete trigger:** Breakeven first-street FE given second-street FE.
...
// breakevenFoldEquityFirstStreetPureBluff(...) — see signature above
```
