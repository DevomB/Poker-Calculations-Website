...
sidebar_label: twoStreetPureBluffEv
description: "Two-street pure-bluff chip EV with independent FE per street."
---

## Summary

Two-street pure-bluff chip EV with independent FE per street.
...
**Concrete trigger:** Two-street pure-bluff chip EV with independent FE per street.
...
// twoStreetPureBluffEv(...) — see signature above
```
