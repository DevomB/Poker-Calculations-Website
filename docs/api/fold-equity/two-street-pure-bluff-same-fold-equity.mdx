...
sidebar_label: twoStreetPureBluffSameFoldEquity
description: "Same FE both streets, pure air; may return `NaN`."
---

## Summary

Same FE both streets, pure air; may return `NaN`.
...
**Concrete trigger:** Same FE both streets, pure air; may return `NaN`.
...
// twoStreetPureBluffSameFoldEquity(...) — see signature above
```
