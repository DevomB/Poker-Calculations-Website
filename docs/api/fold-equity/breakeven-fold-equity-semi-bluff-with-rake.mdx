...
sidebar_label: breakevenFoldEquitySemiBluffWithRake
description: "Semi-bluff FE with rake on `totalPotIfCalled`."
---
...
**Concrete trigger:** Semi-bluff FE with rake on `totalPotIfCalled`.
...
// breakevenFoldEquitySemiBluffWithRake(...) — see signature above
```
