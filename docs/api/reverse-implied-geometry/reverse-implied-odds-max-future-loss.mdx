...
sidebar_label: reverseImpliedOddsMaxFutureLoss
description: "reverseImpliedOddsMaxFutureLoss"
---

## Summary

Native export `reverseImpliedOddsMaxFutureLoss` from the `poker-calculations` addon.
...
// reverseImpliedOddsMaxFutureLoss(...) — see signature above
```
