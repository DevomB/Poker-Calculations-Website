...
sidebar_label: exactHuEquityVsRandomHand
description: "Exact HU equity vs uniform random villain hand; board must have **3–5** cards."
---
...
**Concrete trigger:** Exact HU equity vs uniform random villain hand; board must have **3–5** cards.
...
// exactHuEquityVsRandomHand(...) — see signature above
```
