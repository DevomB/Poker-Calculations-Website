...
sidebar_label: sidePotLadderFromCommitments
description: "sidePotLadderFromCommitments"
---

## Summary

Native export `sidePotLadderFromCommitments` from the `poker-calculations` addon.
...
// sidePotLadderFromCommitments(...) — see signature above
```

Runnable sample in the repo: [NPM/examples/side-pots.mjs](https://github.com/DevomB/Poker-Calculations/blob/main/NPM/examples/side-pots.mjs).
