...
sidebar_label: layeredPotChipEvFromEquities
description: "Chip EV; each column sums to `1`."
---

## Summary

Chip EV; each column sums to `1`.
...
**Concrete trigger:** Chip EV; each column sums to `1`.
...
// layeredPotChipEvFromEquities(...) — see signature above
```
