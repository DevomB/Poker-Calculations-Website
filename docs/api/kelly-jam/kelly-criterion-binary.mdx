...
sidebar_label: kellyCriterionBinary
description: "kellyCriterionBinary"
---

## Summary

Native export `kellyCriterionBinary` from the `poker-calculations` addon.
...
// kellyCriterionBinary(...) — see signature above
```
