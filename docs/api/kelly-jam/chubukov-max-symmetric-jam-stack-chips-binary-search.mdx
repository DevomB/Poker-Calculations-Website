...
sidebar_label: chubukovMaxSymmetricJamStackChipsBinarySearch
description: "Largest integer jam stack in `[1, max]` with nonnegative EV for fixed equity."
---

## Summary

Largest integer jam stack in `[1, max]` with nonnegative EV for fixed equity.
...
**Concrete trigger:** Largest integer jam stack in `[1, max]` with nonnegative EV for fixed equity.
...
// chubukovMaxSymmetricJamStackChipsBinarySearch(...) — see signature above
```
