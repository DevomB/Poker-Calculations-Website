---
title: sprAfterCall
sidebar_label: sprAfterCall
description: "SPR after HU single call; throws if `toCall` > stack."
---

## Summary

SPR after HU single call; throws if `toCall` > stack.
...
**Concrete trigger:** SPR after HU single call; throws if `toCall` > stack.
...
// sprAfterCall(...) — see signature above
```
