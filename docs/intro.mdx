...
| [Concepts](/docs/concepts/card-notation) | Cards, hand ranks, errors |
| [Guides](/docs/guides/decide-action) | `decideAction`, Monte Carlo, ICM |
| [API reference](/docs/reference/api) | All **98** native exports |
