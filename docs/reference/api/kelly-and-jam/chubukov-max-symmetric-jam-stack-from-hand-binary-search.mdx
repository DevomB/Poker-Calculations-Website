...
<div className="apiSignature">{`chubukovMaxSymmetricJamStackFromHandBinarySearch(heroHoleCards: CardInput, boardCards: CardInput, deadMoneyChips: number, maxStackChips: number): number`}</div>
